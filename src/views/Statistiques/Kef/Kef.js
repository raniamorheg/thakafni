  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Card>
          <CardHeader>
            <i className="fa fa-align-justify"></i><strong>Kef</strong>
            <div className="card-header-actions">
              <a href="https://reactstrap.github.io/components/Kef/" rel="noreferrer noopener" target="_blank" className="card-header-action">
